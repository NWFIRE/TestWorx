...
const features = [
  ...
  { title: "Invoicing", description: "Review service and material quantities, then sync to QuickBooks for final pricing and tax.", icon: Receipt },
...
export function FeatureGridSection() {
  return (
    <section className="bg-[#f2f7fa] py-20 xl:py-24" id="features">
      <SectionContainer>
