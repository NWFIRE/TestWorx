...
export function LogoLockup() {
  return (
    <Link className="inline-flex items-center gap-3" href="/">
      ...
      <div>
        <p className="text-[1.05rem] font-semibold tracking-[-0.04em] text-slate-950">TradeWorx</p>
        <p className="text-[11px] font-medium uppercase tracking-[0.2em] text-slate-500">Fire Service Platform</p>
      </div>
    </Link>
  );
}
