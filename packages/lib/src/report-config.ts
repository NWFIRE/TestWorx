      ...
      fields: [
        {
          ...
          field: "laborHours",
          category: "labor",
          description: "Fire Alarm Inspection Labor",
          code: "FIRE_ALARM_INSPECTION_LABOR",
          unit: "hours",
    ...
    sections: [
      {
        ...
        fields: [
          ...
          { id: "monitoringCompanyName", label: "Monitoring company", type: "text", placeholder: "Central station / monitoring company", prefill: [{ source: "priorField", sectionId: "control-panel", fieldId: "monitoringCompanyName" }] },
          { id: "monitoringAccountNumber", label: "Monitoring account number", type: "text", placeholder: "Account, site, or subscriber number", prefill: [{ source: "priorField", sectionId: "control-panel", fieldId: "monitoringAccountNumber" }] },
          { id: "monitoringPhone", label: "Monitoring phone", type: "text", placeholder: "Monitoring company phone", prefill: [{ source: "priorField", sectionId: "control-panel", fieldId: "monitoringPhone" }] },
          { id: "monitoringContactName", label: "Monitoring contact", type: "text", placeholder: "Operator, dispatcher, or contact name", prefill: [{ source: "priorField", sectionId: "control-panel", fieldId: "monitoringContactName" }] },
