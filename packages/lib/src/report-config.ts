...
export const inspectionTypeRegistry: Record<InspectionType, ReportTemplateDefinition> = {
  ...
  backflow: {
    label: "Backflow",
    description: "Backflow preventer testing, relief valve behavior, and certification support.",
    pdf: {
      subtitle: "Backflow Prevention Inspection Report",
      nfpaReferences: ["NFPA 13", "NFPA 25"]
    },
    sections: [
      {
        ...
        description: "Capture serials, assembly type, size, and location readiness.",
        fields: [
          {
            id: "assemblies",
            label: "Backflow assemblies",
            description: "Track each tested backflow preventer assembly linked to the site.",
            type: "repeater",
            ...
            rowFields: [
                ...
                mappings: [
                  {
                    ...
                    targets: [
                      ...
                      { fieldId: "sizeInches", sourceKey: "sizeInches", mode: "if_empty" },
                      { fieldId: "serialNumber", sourceKey: "serialNumber", mode: "if_empty" }
                    ]
                  }
                ]
              },
              {
                ...
                prefill: [
                  { source: "asset", key: "assetTag" },
                  { source: "priorField", sectionId: "assembly", fieldId: "assetTag" }
                ]
              },
              {
                id: "location",
                label: "Location",
                type: "text",
                placeholder: "Loading dock mechanical",
                prefill: [
                  { source: "assetMetadata", key: "location" },
                  { source: "priorField", sectionId: "assembly", fieldId: "location" },
                  { source: "siteDefault", key: "siteName" }
                ]
              },
              {
                ...
                prefill: [
                  { source: "assetMetadata", key: "assemblyType" },
                  { source: "priorField", sectionId: "assembly", fieldId: "assemblyType" }
                ]
              },
              {
                id: "sizeInches",
                label: "Assembly size (inches)",
                type: "number",
                placeholder: "2",
                prefill: [
                  { source: "assetMetadata", key: "sizeInches" },
                  { source: "priorField", sectionId: "assembly", fieldId: "sizeInches" }
                ]
              },
              {
                id: "serialNumber",
                label: "Serial number",
                type: "text",
                placeholder: "BF-RPZ-4421",
                prefill: [
                  { source: "assetMetadata", key: "serialNumber" },
                  { source: "priorField", sectionId: "assembly", fieldId: "serialNumber" }
                ]
              },
              {
                id: "serialVerified",
                label: "Serial verified",
                type: "boolean",
                prefill: [{ source: "reportDefault", value: true }]
              }
            ]
          },
          {
            id: "assembliesInspected",
            label: "Assemblies inspected",
            type: "number",
            placeholder: "0",
          ...
          {
            id: "allSerialsVerified",
            label: "All serials verified",
            type: "boolean",
            calculation: {
              key: "allRowsEqual",
              sourceFieldId: "assemblies",
              rowFieldId: "serialVerified",
              equals: true,
              emptyValue: false
            },
            readOnly: true
      ...
      },
      {
        id: "test-results",
        label: "Test results",
        description: "Record differential readings and relief valve outcome.",
        fields: [
          {
            id: "checkValveOnePsi",
            label: "Check valve #1 PSI",
            type: "number",
            placeholder: "0.0",
            prefill: [{ source: "priorField", sectionId: "test-results", fieldId: "checkValveOnePsi" }]
          },
          {
            id: "checkValveTwoPsi",
            label: "Check valve #2 PSI",
            type: "number",
            placeholder: "0.0",
            prefill: [{ source: "priorField", sectionId: "test-results", fieldId: "checkValveTwoPsi" }]
          },
          {
            id: "reliefValveOpened",
            label: "Relief valve opened correctly",
            type: "boolean",
            prefill: [{ source: "priorField", sectionId: "test-results", fieldId: "reliefValveOpened" }]
          }
        ]
      },
      {
        id: "certification",
        label: "Certification and repairs",
        description: "Track pass/fail outcome and immediate repair notes.",
        fields: [
          {
            id: "testOutcome",
            label: "Test outcome",
            type: "select",
            optionProvider: "passFail",
            prefill: [{ source: "priorField", sectionId: "certification", fieldId: "testOutcome" }]
          },
          {
            id: "repairRecommended",
            label: "Repair recommended",
            type: "boolean",
            prefill: [{ source: "priorField", sectionId: "certification", fieldId: "repairRecommended" }]
          },
          { id: "certificationNotes", label: "Certification notes", type: "text", placeholder: "Local authority forms, tags, or repair notes" }
        ]
      }
    ]
  },
